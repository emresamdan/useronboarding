...
const faqs = [
  {
    id: 1,
    question: "What is Userflow?",
    answer:
      "Userflow is a user engagement tool that helps you onboard your users with interactive walkthroughs, tooltips, hotspots, checklists, and NPS surveys. ",
  },
  {
    id: 2,
    question: "Why do we use Userflow?",
    answer:
      "Userflow can be used to train or onboard employees and end-users, announce product updates and new features, and track user activity and engagement rates.",
  },
  {
    id: 3,
    question: "How do I use Userflow?",
    answer:
          "To be able to use Userflow, you should subscribe to the tool and create a profile. Then, you should copy the provided JavaScript code and paste it into your own product's code. After the installation, you can start creating guides on the product.",
  },
  {
    id: 4,
    question: "Does Userflow have a mobile app?",
    answer:
      "No, Userflow doesn't have a mobile app, as well as a desktop app.",
  },
  {
    id: 5,
    question: "Does Userflow work on mobile?",
    answer:
      "Yes, you can use Userflow to create mobile app guides. But, since Userflow doesn't have a mobile app, you would have to use the online tool to create the guides.",
   },
  {
    id: 6,
    question: "Is Userflow free?",
    answer:
      "No, Userflow can be used with a monthly subscription. Userflow's startup plan costs $200/month and the pro plan costs $600/month if paid annually.",
    },
  {
    id: 7,
    question: "What is Userflow JavaScript code?",
    answer:
      "The JavaScript code is what enables you to use Userflow guides in your product. In other words, the JavaScript code is used to integrate Userflow into your product.",
    },
];
...
const pricing = {
    tiers: [
      ...
      description: "",
      features: [
        "For only 3000 users with annual billing.",
        "Includes unlimited flows",
        "1 checklist",
        "3 team members",
      ],
      cta: "Monthly billing",
    ...
    },
    {
      ...
      features: [
        "Up to  10,000 users with annual billing.",
        "Includes unlimited flows",
        "Surveys and NPS",
              ...
              <div className="mt-20">
                ...
                <div className="mt-6 sm:max-w-xl">
                  ...
                  <p className="mt-6 text-xl text-gray-500">
                                      Userflow is a virtual onboarding and product adoption tool that allows users to train their end-users with a selection of onboarding materials.
                                      The tool is a good option in some ways like being efficient on complex UI's or advanced analytics options.
                  </p>
                </div>
            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              ...
              <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
                <img
                  ...
                  src="assets/reviews/userflow.png"
                  alt=""
                />
              </div>
            </div>
            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                ...
                <p className="relative">
                 <b>"Difficult to Get Support"</b>
                 <p>Had to reach out to support for quite a few tips. The support page wasn't very well comprehensive and lacked an easy UI to search and find what I was looking for.</p>
          ...
          <div className="py-12 px-4 border-t-2 border-indigo-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                ...
                <p className="relative">
                      <b>"Limited Mobile Device Access"</b>
                      <p>Limited on what I can access from my mobile phone on Userflow platform. Takes a long time to load and occasionally failing completely to be accessible on my Android OS device.</p>
