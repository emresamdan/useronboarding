                ...
                <div className="mt-6">
                  <div className="inline-flex items-center divide-x divide-gray-300">
                    ...
                    <div className="min-w-0 flex-1 pl-5 py-1 text-sm text-gray-500 sm:py-3">
                      ...
                      by over{" "}
                      <a href="https://www.g2.com/products/userguiding/reviews"  target="_blank">
        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:px-6 lg:px-8">
          <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-indigo-900 lg:pr-16">
            <div className="md:flex-shrink-0 w-12">
              <a href="https://www.g2.com/products/userguiding/reviews/userguiding-review-4556535" target="_blank">
                <img
                  className="h-12"
