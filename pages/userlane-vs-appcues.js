...
const plans = [
    {
        ...
        mainFeatures: [
            { id: 1, value: 'Easier to use and setup' },
...
export default function popupsmartvssleeknote() {
    return (
        <div className="bg-white">
                     <Seo
        title="Userlane vs Appcues Comparison - UserOnboarding.Academy"
        description="Let's compare Userlane and Appcues and also cover some of the best features that offer better value for money."/>
            <Navbar />
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                        Let's compare <b>Userlane</b> and <b>Appcues</b> and also cover some of the best features that offer better value for money.
                    </p>
                </div>
            </div>
