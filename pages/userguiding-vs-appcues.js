...
const plans = [
    {
        ...
        priceYearly: 82,
        mainFeatures: [
            { id: 1, value: 'Affordable Price' },
            { id: 2, value: 'Easy ease of use and setup' },
            { id: 3, value: 'Simple Analytics, Segmentation and Targeting' },
    ...
    },
    {
        title: 'Appcues',
        featured: true,
        description: 'Appcues is also one of the most expensive user onboarding tools.',
        priceMonthly: 299,
        priceYearly: 249,
        mainFeatures: [
            { id: 1, value: 'Not easy to use and setup' },
            { id: 2, value: 'Advanced Analytics, Segmentation and Targeting' },
            { id: 3, value: 'Great Customization' },
            { id: 4, value: 'Great education' },
            { id: 5, value: 'Multilingual User Onboarding' },
            { id: 6, value: 'Excellent Customer Support' },
        ],
    },
...
const features = [
    {
        ...
        tiers: [
            ...
            { title: 'appcues', featured: true, value: true },
        ],
    },
    {
        title: 'Tooltips ',
    ...
    },
    {
        ...
        tiers: [
            { title: 'userguiding', value: true },
            { title: 'appcues', featured: true, value: false },
...
export default function popupsmartvssleeknote() {
    return (
        <div className="bg-white">
            ...
            <Seo
        title="UserGuiding vs Appcues Comparison - UserOnboarding.Academy"
        description="Let's compare UserGuiding and Appcues and also cover some of the best features that offer better value for money."/>
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                        Let's compare  <b>UserGuiding</b> and <b>Appcues</b> and also cover some of the best features that offer better value for money.
                    </p>
                </div>
            </div>
