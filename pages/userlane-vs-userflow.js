...
const plans = [
    {
        ...
        mainFeatures: [
            ...
            { id: 2, value: 'Good Analytics but No downloadable Analytics Report' },
    ...
    },
    {
        ...
        mainFeatures: [
            ...
            { id: 4, value: 'Has different Pricing Models' },
            { id: 5, value: 'Multilingual User Onboarding' },
...
export default function popupsmartvssleeknote() {
    return (
        ...
        description="Let's compare Userlane and Userflow and also cover some of the best features that offer better value for money."/>
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                        Let's compare <b>Userlane</b> and <b>Userflow</b> and also cover some of the best features that offer better value for money.
                    </p>
                </div>
            </div>
