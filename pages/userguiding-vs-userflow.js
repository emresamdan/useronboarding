...
const plans = [
    {
        ...
        priceYearly: 82,
        mainFeatures: [
            { id: 1, value: 'Ease of use, setup, and integration with Affordable Price' },
            { id: 2, value: 'Simple Analytics, Segmentation and Targeting, Personalization' },
            { id: 3, value: 'Good Functionality' },
            { id: 4, value: 'Great Customization' },
    ...
    },
    {
        title: 'Userflow',
        featured: true,
        description: 'Userflow has capable user onboarding elements but it has complex integration, complex UI, and high pricing.',
        priceMonthly: 200,
        priceYearly: 200,
        mainFeatures: [
            { id: 1, value: 'Not easy to integrate, use, and setup' },
            { id: 2, value: 'Advanced Analytics, Segmentation and Targeting' },
            { id: 3, value: 'Good Functionality' },
            { id: 4, value: 'Great Analytics' },
            { id: 5, value: 'Multilingual User Onboarding' },
            { id: 6, value: 'Weak Customer Support' },
        ],
    },
...
const features = [
    {
        ...
        tiers: [
            ...
            { title: 'userflow', featured: true, value: true },
        ],
    },
    {
        title: 'Tooltips ',
    ...
    },
    {
        ...
        tiers: [
            { title: 'userguiding', value: true },
            { title: 'userflow', featured: true, value: false },
...
export default function popupsmartvssleeknote() {
    return (
        ...
        <div className="bg-white">
                     <Seo
        title="UserGuiding vs Userflow Comparison - UserOnboarding.Academy"
        description="Let's compare UserGuiding and Userflow and also cover some of the best features that offer better value for money."/>
            <Navbar />
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
                        Let's compare  <b>UserGuiding</b> and <b>Userflow</b> and also cover some of the best features that offer better value for money.                      
                    </p>
                </div>
            </div>
